...
class Solution
{
    ...
    Node *copyList(Node *head)
    {
        ...
        //step 2: clone nodes in between original nodes
        ...
        while(temp != NULL){
            if(temp->next != NULL){
                ...
                temp = temp->next->next; // agli vali node pe pochne ke liye
            }
        }
        
        //step 4: revert changing steps from 2
